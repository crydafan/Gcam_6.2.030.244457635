...
public class GLFramebufferObject implements Closeable {
    ...
    public void attachAsDraw(int i, GLTexture2D gLTexture2D) {
        GLES31.glFramebufferTexture2D(36009, i + 36064, 3553, gLTexture2D.id(), 0);
    }

    public void attachAsRead(int i, GLTexture2D gLTexture2D) {
        GLES31.glFramebufferTexture2D(36008, i + 36064, 3553, gLTexture2D.id(), 0);
    }
    ...
    public void detachAsDraw(int i) {
        GLES31.glFramebufferTexture2D(36009, i + 36064, 3553, 0, 0);
    }

    public void detachAsRead(int i) {
        GLES31.glFramebufferTexture2D(36008, i + 36064, 3553, 0, 0);
    }
