...
public class Matrix2f {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Matrix2f) {
            ...
            return this.m00 == matrix2f.m00 && this.m10 == matrix2f.m10 && this.m01 == matrix2f.m01 && this.m11 == matrix2f.m11;
        }
        return false;
    }
    ...
    public String toString() {
        return String.format("[\t%f\t%f\t]\n[\t%f\t%f\t]", Float.valueOf(this.m00), Float.valueOf(this.m01), Float.valueOf(this.m10), Float.valueOf(this.m11));
    }
}
